											...
											<div class="row">
												...
												<div class="col-md-7"><br>
													<div class="card text-white bg-info mb-3">
														<div class="card-header"><b>PERFIL</b></div>
														<div class="card-body">
															...
															<form method="POST">
																...
																<div class="row">
																	<div class="col">
																		<input type="text" onkeyup="usuarioInteractuo()" id="nombre_apellido" name="nombre_apellido" value="<?php echo $nombre_apellido ?>" class="form-control" placeholder="Nombre y Apellido">
																	</div>
																	<div class="col">
																		<input type="text" onkeyup="usuarioInteractuo()" id="usuario" name="usuario" value="<?php echo $usuario ?>" class="form-control" placeholder="Usuario">
																	</div>
																</div>
																<br>
																<div class="row">
																	<div class="col">
																		<input type="text" onkeyup="usuarioInteractuo()" id="email" name="email" value="<?php echo $email ?>" class="form-control" placeholder="Correo">
																	</div>
																</div>
																<br>
																<button type="button" id="actualizar-perfil" onclick="deshabilitarBoton()" class="btn btn-dark btn-block" disabled="true">ACTUALIZAR</button>
															</form>
													...
													<div class="card text-white bg-secondary mb-3">
														<div class="card-header"><b>¿NO TIENES SALDO?</b></div>
														<div class="card-body">
															Contacta a soporte o crear un ticket <a href="soporte" style="color: black;">Aqui</a>
														</div>
													</div>
