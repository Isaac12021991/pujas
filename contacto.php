	...
	<div class="page-title">
		<div class="container">
			<div class="page-caption">
				<h2>Contactanos</h2>
				<p><a href="index">Inicio</a> <i class="ti-angle-double-right"></i> Contactanos</p>
			</div>
		</div>
	</div>
	<!-- ======================= Title ===================== --> 
						...
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<center>
									...
									<h3>CONTACTANOS</h3>
									<hr>
									<h4><img src="img/tel.png" width="30"> (1234) 12345678</h4>
									<h4>Contacto Whatsapp ó Ticket de Soporte </h4>
									<h4>contacto@latinclub.net</h4>
								</center>
							</div>	     
						</div>
					</div>
